...
public class BillResult {
	...
	public void setNowMonthIncome(Double nowMonthIncome) {
		this.nowMonthIncome = nowMonthIncome == null ? 0.0 : nowMonthIncome;
	}
	...
	public void setNowMonthPay(Double nowMonthPay) {
		this.nowMonthPay = nowMonthPay == null ? 0.0 : nowMonthPay;
	}
	...
	public void setNowDayIncome(Double nowDayIncome) {
		this.nowDayIncome = nowDayIncome == null ? 0.0 : nowDayIncome;
	}
	...
	public void setNowDayPay(Double nowDayPay) {
		this.nowDayPay = nowDayPay == null ? 0.0 : nowDayPay;
	}
	...
	public void setNowWeekIncome(Double nowWeekIncome) {
		this.nowWeekIncome = nowWeekIncome == null ? 0.0 : nowWeekIncome;
	}
	...
	public void setNowWeekPay(Double nowWeekPay) {
		this.nowWeekPay = nowWeekPay == null ? 0.0 : nowWeekPay;
	}
