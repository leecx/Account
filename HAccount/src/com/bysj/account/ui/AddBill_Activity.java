...
import com.bysj.account.adapter.GridViewAdapter;
import com.bysj.account.model.GridViewEntity;
...
public class AddBill_Activity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.income_btn:
			...
			break;
		case R.id.cash_btn:
			/*intent = new Intent(AddBill_Activity.this, DialogActivity.class);
			AddBill_Activity.this.startActivityForResult(intent, REQCODE);*/
			break;
	...
	/*private long insertBill(GridViewEntity inent) {
		service = new UserService(AddBill_Activity.this);
